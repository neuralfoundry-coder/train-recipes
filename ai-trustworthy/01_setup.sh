#!/bin/bash
# ==============================================================================
# AI Trustworthiness Environment Setup Script
...
print_banner() {
    echo -e "${BLUE}"
    echo "╔══════════════════════════════════════════════════════════════╗"
    echo "║      AI Trustworthiness Environment Setup (uv)               ║"
...
print_activation_instructions() {
    ...
    echo -e "  ${YELLOW}./04_evaluate.sh${NC}   # Evaluate model"
    echo ""
    echo -e "${BLUE}Dataset:${NC} neuralfoundry-coder/korean-llm-trustworthiness-benchmark-full"
    echo -e "${BLUE}Categories:${NC} Helpfulness, Harmlessness, Honesty"
    echo ""
}
