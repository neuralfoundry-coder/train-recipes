#!/bin/bash
# ==============================================================================
# GPT-OSS 20B Chat Console Script
...
print_banner() {
    echo -e "${CYAN}"
    echo "╔══════════════════════════════════════════════════════════════╗"
    echo "║       GPT-OSS 20B Korean Education Chat Console             ║"
    echo "╚══════════════════════════════════════════════════════════════╝"
    echo -e "${NC}"
}
...
print_help() {
    ...
    echo "  -r, --reasoning LVL   Reasoning effort: low, medium, high (default: $REASONING_EFFORT)"
    ...
    echo ""
    echo -e "${GREEN}GPT-OSS Reasoning Effort:${NC}"
    ...
    echo "  $0 -m ./logs/gpt-oss-20b_.../lora_model"
    echo "  $0 -g 1 -r high        # Use GPU 1 with high reasoning"
    ...
    echo "  /reasoning  - Change reasoning effort (low/medium/high)"
...
run_chat() {
    ...
    CMD="python chat_console.py --gpu $GPU_ID --max-tokens $MAX_TOKENS --reasoning $REASONING_EFFORT"
